  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: const [
            ...
            Tab(icon: Icon(Icons.credit_card_outlined), text: 'Cicilan'),
          ],
      ...
      floatingActionButton: _tabController.index == 0
          ...
          : FloatingActionButton.extended(
              heroTag: 'addCicilanFAB',
              onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const AddCicilanScreen())),
              icon: const Icon(Icons.add),
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 4),
                                  Text(CurrencyFormat.formatRupiah(goal.currentAmount),
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 4),
                                  Text(CurrencyFormat.formatRupiah(goal.targetAmount),
                            ...
                            child: Column(
                              children: [
                                Row(children: [
                                  ...
                                  Expanded(child: Text('Per Bulan: ${CurrencyFormat.formatRupiah(goal.currentMonthlyRecommendation)}',
                                ...
                                Row(children: [
                                  ...
                                  const SizedBox(width: 8),
                                  Expanded(child: Text('Per Minggu: ${CurrencyFormat.formatRupiah(goal.currentWeeklyRecommendation)}',
                                      style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: AppColors.primary))),
                                ]),
                                const SizedBox(height: 6),
                                Row(children: [
                                  ...
                                  const SizedBox(width: 8),
                                  Expanded(child: Text('Per Hari: ${CurrencyFormat.formatRupiah(goal.currentDailyRecommendation)}',
                                      style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: AppColors.primary))),
                                ]),
                              ],
                            ),
  ...
  void _showAddDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: const Text('Tambah Target', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
        content: Column(
          ...
          children: [
            ListTile(
              ...
              title: const Text('Target Tabungan', style: TextStyle(fontWeight: FontWeight.w600)),
              subtitle: const Text('Nabung untuk impian masa depan', style: TextStyle(fontSize: 12)),
              onTap: () {
                Navigator.pop(context);
                Navigator.push(context, MaterialPageRoute(builder: (_) => const AddSavingsGoalScreen()));
              },
            ),
            const SizedBox(height: 8),
            ListTile(
              leading: Container(
                ...
                child: const Icon(Icons.credit_card, color: Colors.orange, size: 28),
              ),
              title: const Text('Cicilan', style: TextStyle(fontWeight: FontWeight.w600)),
              subtitle: const Text('Pantau pembayaran cicilan bulanan', style: TextStyle(fontSize: 12)),
              onTap: () {
                Navigator.pop(context);
                Navigator.push(context, MaterialPageRoute(builder: (_) => const AddCicilanScreen()));
              },
            ),
          ],
        ),
