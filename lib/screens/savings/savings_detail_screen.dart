            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 12),
                  Text('Rekomendasi per bulan: ${CurrencyFormat.formatRupiah(widget.goal.currentMonthlyRecommendation)}',
                      style: const TextStyle(color: Colors.blue, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 4),
                  Text('Rekomendasi per minggu: ${CurrencyFormat.formatRupiah(widget.goal.currentWeeklyRecommendation)}',
                      style: const TextStyle(color: Colors.blue, fontWeight: FontWeight.w500, fontSize: 13)),
                  const SizedBox(height: 4),
                  Text('Rekomendasi per hari: ${CurrencyFormat.formatRupiah(widget.goal.currentDailyRecommendation)}',
                      style: const TextStyle(color: Colors.blue, fontWeight: FontWeight.w500, fontSize: 13)),
                ],
              ),
            ),
